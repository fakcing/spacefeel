...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 h-14 border-b md:block hidden" style={{ borderColor: 'var(--nav-border)' }}>
      <div className="max-w-7xl mx-auto px-4 md:px-8 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div ref={containerRef} className="relative">
            <div
              className="flex items-center rounded-xl px-3 py-2 gap-2 w-48 md:w-64 h-9 transition-all duration-200"
              style={{
