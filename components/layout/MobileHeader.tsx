            ...
            <AnimatePresence>
              {profileOpen && session && (
                <motion.div
                  ...
                  className="absolute top-full right-0 mt-2 w-56 rounded-2xl shadow-2xl p-3 z-50"
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 rounded-xl py-2.5 px-3 text-sm font-medium transition-colors"
